...
dmax <- max(dist(dnos_in@coords))/2 #foi calculada a distancia maxima, para posteriormente ser usada no limite dos residuos do semivariograma

```
Mapa com a localização dos pontos amostrais distribuidos sobre o mapa pedológico da área.
...
#testar com o gstat
#ou predizer diretamente pelo lm_fit, sem o nugget
