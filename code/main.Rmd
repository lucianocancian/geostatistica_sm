...
#como tem sibcs 2013 e sibcs 2009 como nome de coluna, como unir??
```{r}
...
Carregados os dados dos três conjuntos, serão agora visualizados os dados de classe de solo de cada um, buscando visualizar inconsistências ou denominações diferentes às mesmas classes de solo. A fim de facilitar a predição, em um primeiro momento serão utilizadas apenas as informações do segundo nível categorico das classes de solo, conforme o Sistema Brasileiro de Classificação de Solos (SiBCS).
...
#criar espaço para que a figura seja gerada
dev.off()
png("mapa.png")
